...
#        weights <- wres
        ...
        if (plot_trajectories && ((day == 1 && trial == 4) || (day == 8 && trial == 4)))
        {
        ...
        if (plot_cognitive_maps && ((day == 1 && trial == 4) || (day == 8 && trial == 4))) {
          plot(pool_diameter/2*cos(th), pool_diameter/2*sin(th),
               type = "l",
               xlab = paste("day ", day, ", trial ", trial),
               ylab = "cognitive map")
...
mtext("Place Cell Model: Trajectories and Cognitive Maps",
